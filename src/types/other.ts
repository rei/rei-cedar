...
export type ContentPositionValue = 'top' | 'right' | 'bottom' | 'left' | 'overlay';
export type ContentPositionObject = { [key in Breakpoint]: ContentPositionValue };
export type ContentPosition = ContentPositionValue | ContentPositionObject;
