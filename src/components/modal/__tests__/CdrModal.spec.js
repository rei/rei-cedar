...
describe('CdrModal.vue', () => {
  ...
  describe('ARIA show/hide for screen reader', () => {
    ...
    it('does aria-hide elements that should be hidden', () => {
    ...
    it('does not show elements that are already aria-hidden on modal close', () => {
      wrapper.setProps({ opened: false });
      expect(ariaHiddenEl.getAttribute('aria-hidden')).to.equal('true');
    });

    it('removes aria-hidden from hidden elements on close', () => {
      wrapper.setProps({ opened: false });
