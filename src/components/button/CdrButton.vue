...
const props = defineProps({
  ...
  modifier: {
    ...
    validator: (value: string) =>
      propValidator(value, ['primary', 'secondary', 'sale', 'dark', 'link']),
  },
  /**
  ...
  fullWidth: {
    ...
    validator: (value: string) => {
      if (typeof value === 'string') {
        return propValidator(value, ['@xs', '@sm', '@md', '@lg'], false);
      }
...
const withBackgroundClass = computed(() =>
...
<style lang="scss" module src="./styles/CdrButton.module.scss"></style>
