<template>
  <div>
    ...
    <cdr-select
      ...
      prompt="Choose One"
    >
      <template #helper-text>This is helper text.</template>
    ...
    >
      <template #helper-text>Choosing 'b' will result in an error</template>
    ...
    <h3 class="stack">Multiple Select with size</h3>
    ...
    <h3 class="stack">Multiple Select</h3>
