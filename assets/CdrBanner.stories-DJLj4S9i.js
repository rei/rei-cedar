import{n as e}from"./chunk-BneVvdWh.js";import{j as t,m as n}from"./componentOptions-jKL8eaN0.js";import{n as r,t as i}from"./CdrBanner-BBaqurO-.js";import{n as a,t as o}from"./CdrButton-DeOQTtxS.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b;e((()=>{r(),a(),n(),s={title:`Components/Banner`,component:i,tags:[`autodocs`],args:{type:`default`},argTypes:{type:{control:`select`,options:t,description:`Sets the banner type`,table:{type:{summary:t.join(` | `)},defaultValue:{summary:`default`}}}}},c={args:{type:`default`},render:e=>({components:{CdrBanner:i},setup(){return{args:e}},template:`<CdrBanner v-bind="args">This is a default banner message.</CdrBanner>`})},l={args:{type:`info`},render:e=>({components:{CdrBanner:i},setup(){return{args:e}},template:`<CdrBanner v-bind="args">Free shipping on orders over $50.</CdrBanner>`})},u={args:{type:`warning`},render:e=>({components:{CdrBanner:i},setup(){return{args:e}},template:`<CdrBanner v-bind="args">Limited stock available. Order soon!</CdrBanner>`})},d={args:{type:`success`},render:e=>({components:{CdrBanner:i},setup(){return{args:e}},template:`<CdrBanner v-bind="args">Your order has been placed successfully!</CdrBanner>`})},f={args:{type:`error`},render:e=>({components:{CdrBanner:i},setup(){return{args:e}},template:`<CdrBanner v-bind="args">There was an error processing your request.</CdrBanner>`})},p={render:()=>({components:{CdrBanner:i},template:`
    ...
    `})},m={args:{type:`info`},render:e=>({components:{CdrBanner:i},setup(){return{args:e}},template:`
    ...
    `})},h={render:()=>({components:{CdrBanner:i},template:`
      <div class="story-spacing story-spacing--vertical">
        <div>
    ...
    `})},g={render:()=>({components:{CdrBanner:i,CdrButton:o},template:`
      <div class="story-spacing story-spacing--vertical">
        <div>
    ...
    `})},_={render:()=>({components:{CdrBanner:i},template:`
      <CdrBanner type="info">
        <template #icon-left>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/>
    ...
    `})},v={render:()=>({components:{CdrBanner:i},template:`
      <div class="story-spacing story-spacing--vertical">
        <div>
    ...
    `})},y={render:()=>({components:{CdrBanner:i},template:`
      <div class="story-spacing story-spacing--vertical">
        <div>
...
}`,...y.parameters?.docs?.source}}},b=[`Default`,`Info`,`Warning`,`Success`,`Error`,`AllTypes`,`WithMessageBody`,`WithIconLeft`,`WithIconRight`,`WithInfoAction`,`MultipleSlots`,`UseCases`]}))();export{p as AllTypes,c as Default,f as Error,l as Info,v as MultipleSlots,d as Success,y as UseCases,u as Warning,h as WithIconLeft,g as WithIconRight,_ as WithInfoAction,m as WithMessageBody,b as __namedExportsOrder,s as default};